...
#         # Update PDF files
#         if pdf_files:
#             instance.pdf_files.clear()  # Remove existing PDFs
#             for pdf_file in pdf_files:
#                 saved_location = save_image_to_folder(pdf_file.read(), instance._id, pdf_file.name)
#                 pdf = PDF.objects.create(name=pdf_file.name, file_path=saved_location)
#                 instance.pdf_files.add(pdf)
